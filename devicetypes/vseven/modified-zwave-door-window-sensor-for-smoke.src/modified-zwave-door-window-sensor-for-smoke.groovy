...
metadata {
	definition (name: "Modified Z-Wave Door/Window Sensor for Smoke", namespace: "sandychak", author: "vSeven.  Modified by sandychak.", mnmn: "SmartThings", ocfDeviceType: "x.com.st.d.sensor.smoke", vid: "generic-smoke") {
